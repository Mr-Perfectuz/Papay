...
exports.board_artilce_status_enum_list = ["active", "deleted"];
...
exports.lookup_auth_following = (mb_id, origin) => {
...
exports.lookup_auth_liked = (mb_id) => {
  return {
    $lookup: {
      from: "likes",
      let: {
      ...
      as: "me_liked", // why not in direct schema ?
    },
  };
};
